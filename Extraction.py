...
def tinyURL(url):
    match = re.findall(shortening_services, url)
    if match:
        return 1
    else:
        return 0
...
def predictResult(URL):
    ...
    svm = pickle.load(open("Models/SupportVectorMachine.pickle.dat", 'rb'))
    xgb = pickle.load(open("Models/XGBoostClassifier.pickle.dat", 'rb'))
